document.addEventListener("DOMContentLoaded", () => {
  ...
  const startCountdown = (targetDate, countdownElement) => {
    const updateCountdown = () => {
      ...
      countdownElement.querySelector(".countdown__number--days").innerHTML =
        days.toString().padStart(2, "0");
      countdownElement.querySelector(".countdown__number--hours").innerHTML =
        hours.toString().padStart(2, "0");
      countdownElement.querySelector(".countdown__number--minutes").innerHTML =
        minutes.toString().padStart(2, "0");
      countdownElement.querySelector(".countdown__number--seconds").innerHTML =
  ...
  targetDates.forEach((date, index) =>
    startCountdown(date, countdownElements[index]),
  );
});
